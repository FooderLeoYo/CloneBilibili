...
const URL_VIDEO_GET_BARR_LIKE_COUNT = prefix + "/av/getbarrlikecount";
...
export {
  ...
  /* 视频相关 */
  URL_VIDEO_DETAIL, URL_VIDEO_GET_BARR, URL_VIDEO_GET_BARR_LIKE_COUNT, URL_VIDEO_PLAY_URL,
  URL_VIDEO_RECOMMEND, URL_VIDEO_REPLAY, URL_VIDEO_REPORT, URL_VIDEO_SEND_BARR,
  URL_VIDEO_THUMBUP_BARR
}
