...
/* 视频相关 */
const URL_VIDEO_BARR_CONTENT = prefix + "/av/getbarr";
const URL_VIDEO_BARR_LIKE_COUNT = prefix + "/av/getbarrlikecount";
const URL_VIDEO_BARR_SEND = prefix + "/av/sendbarr";
const URL_VIDEO_BARR_THUMBUP = prefix + "/av/thumbupbarr";
const URL_VIDEO_BARR_WITHDRAW = prefix + "/av/withdrawbarr"
...
export {
  ...
  /* 个人中心相关 */
  URL_ME_CREATE_FAV, URL_ME_DEL_INVALID_FAV_CONTENT, URL_ME_DELETE_HISTORY,
  URL_ME_EXIT_LOGIN, URL_ME_EDIT_FAV, URL_ME_GET_HISTORY, URL_ME_GET_LATER,
  URL_ME_MY_RELATION,
  /* 排行榜相关 */
  ...
  /* 视频相关 */
  URL_VIDEO_BARR_CONTENT, URL_VIDEO_BARR_LIKE_COUNT, URL_VIDEO_BARR_SEND,
  URL_VIDEO_BARR_THUMBUP, URL_VIDEO_BARR_WITHDRAW, URL_VIDEO_DETAIL,
  URL_VIDEO_PLAY_URL, URL_VIDEO_RECOMMEND, URL_VIDEO_REPLAY, URL_VIDEO_REPORT
}
